...
import type { ExternalBlob as _ExternalBlob, Reel as _Reel, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async getFeed(): Promise<Array<Reel>> {
        if (this.processError) {
            try {
    ...
    async getReel(arg0: bigint): Promise<Reel> {
        if (this.processError) {
            try {
                const result = await this.actor.getReel(arg0);
                return from_candid_Reel_n11(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async getReelsByUploader(arg0: Principal): Promise<Array<Reel>> {
        if (this.processError) {
            try {
                const result = await this.actor.getReelsByUploader(arg0);
                return from_candid_vec_n10(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async uploadReel(arg0: ExternalBlob, arg1: string): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.uploadReel(await to_candid_ExternalBlob_n22(this._uploadFile, this._downloadFile, arg0), arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_Reel_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _Reel): Promise<Reel> {
...
async function from_candid_vec_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_Reel>): Promise<Array<Reel>> {
    return await Promise.all(value.map(async (x)=>await from_candid_Reel_n11(_uploadFile, _downloadFile, x)));
}
...
async function to_candid_record_n21(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        bio: value.bio,
        username: value.username,
        profilePicture: value.profilePicture ? candid_some(await to_candid_ExternalBlob_n22(_uploadFile, _downloadFile, value.profilePicture)) : candid_none()
    };
}
